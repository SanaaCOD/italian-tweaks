...
Write-Log 'PRESENT_SOURCE=PnPPresentOnly' $LogPath
Write-Log 'CACHE_USED_AS_FINAL=false' $LogPath
Write-Log 'REGISTRY_USED_AS_PRESENT=false' $LogPath
Write-Log ("CONNECTED_CONTROLLERS_COUNT=" + $list.Count) $LogPath
exit 0
